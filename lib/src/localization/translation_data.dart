...
/// Canonical localization dataset bundled with the package.
const Map<String, Map<Language, String>> kTranslationData = {
  // Core calendar terms
  'Myanmar Year': {
...
''',
  ...
  'desc_warameittunge': {
    ...
    Language.myanmar: 'ဝါရမိတ္တုငယ်သည် အနည်းငယ် မသင့်တော်သော နေ့တစ်နေ့ဖြစ်သည်။',
  ...
  'desc_yatyotema': {
    ...
    Language.mon: 'တ္ၚဲရက်ယုတ်မာ ဝွံ သွက်ဂွံပ္တိတ်ဒြဟတ်ဂမၠိုင် ဟွံသၟဟ်အစောံရ။',
    Language.shan:
  ...
  'desc_mahayatkyan': {
    ...
    Language.shan: 'ဝၼ်းၵျၢမ်းလူင် မိူၼ်ၼင်ႇ ဝၼ်းလီ တႃႇၵၢၼ်တႄႇ ဢၼ်တေယူႇႁိုင်။',
  },
  'desc_shanyat': {
    Language.english:
...
''',
  ...
  'year_name_desc': {
    ...
    Language.zawgyi: 'ဤနှစ္သည္ ၁၂ နှစ္စက္ဝန္းတ္ောင္း @year နှစ္ဟု လူသိမ္းသည္။',
