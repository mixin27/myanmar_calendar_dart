...
///
/// This class represents a complete date that includes Myanmar date, Western
/// date, astrological information, and holiday information all in one
/// comprehensive object. It serves as the primary data model for applications
/// that need full calendar information for any given date.
///
/// Example:
/// ```dart
...
class CompleteDate {
  ...
  String toDetailedString() {
    final buffer = StringBuffer()
      ..writeln('Complete Date Information:')
      ..writeln(
      ...
      ..writeln('Sasana Year: ${myanmar.sasanaYear}')
      ..writeln('Year Type: ${_getYearTypeName(myanmar.yearType)}')
      ..writeln('Julian Day: ${myanmar.julianDayNumber}');
    ...
    buffer
      ..writeln('Mahabote: ${astro.mahabote}')
      ..writeln('Nakhat: ${astro.nakhat}')
      ..writeln('Year Name: ${astro.yearName}')
      ..writeln('Naga Head: ${astro.nagahle}');
