...
class CalendarUtils {
  ...
  static List<MyanmarDate> convertWesternDatesToMyanmar(
    ...
    for (var i = 0; i < westernDates.length; i += batchSize) {
  ...
  static List<DateTime> convertMyanmarDatesToWestern(
    ...
    for (var i = 0; i < myanmarDates.length; i += batchSize) {
  ...
  static Map<String, dynamic> calculateMyanmarDateStatistics(
    ...
    final jdns = dates.map((d) => d.julianDayNumber).toList()..sort();
    ...
    final median = jdns.length.isEven
  ...
  static List<MyanmarDate> sortMyanmarDatesChronologically(
    ...
    final sorted = copyMyanmarDateList(dates)
      ..sort((a, b) => a.julianDayNumber.compareTo(b.julianDayNumber));
    return sorted;
  }
