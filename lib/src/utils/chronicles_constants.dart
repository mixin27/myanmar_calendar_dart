...
const List<DynastyData> kDynasties = [
  DynastyData(
    id: 'early_pagan',
    name: {'en': 'Early Pagan Kingdom', 'my': 'ခေတ်ဦး ပုဂံ ပြည်'},
    startJdn: 1944957,
    endJdn: 2102602,
  ),
  DynastyData(
    id: 'pagan',
    name: {'en': 'Pagan Kingdom', 'my': 'ပုဂံခေတ်'},
    startJdn: 2102602,
    endJdn: 2195138,
  ),
  DynastyData(
    id: 'hanthawaddy',
    name: {'en': 'Hanthawaddy Dynasty', 'my': 'ဟံသာဝတီ'},
    startJdn: 2191228,
    endJdn: 2287997,
  ),
  DynastyData(
    id: 'myinsaing',
    name: {'en': 'Myinsaing Kingdom', 'my': 'မြင်စိုင်းခေတ်'},
    startJdn: 2195138,
    endJdn: 2200669,
  ),
  DynastyData(
    id: 'pinya',
    name: {'en': 'Pinya Kingdom', 'my': 'ပင်းယခေတ်'},
    startJdn: 2200669,
    endJdn: 2219503,
  ),
  DynastyData(
    id: 'sagaing',
    name: {'en': 'Sagaing Kingdom', 'my': 'စစ်ကိုင်းခေတ်'},
    startJdn: 2201496,
    endJdn: 2219350,
  ),
  DynastyData(
    id: 'ava',
    name: {'en': 'Ava Dynasty', 'my': 'အင်းဝခေတ်'},
    startJdn: 2219350,
    endJdn: 2289043,
  ),
  DynastyData(
    id: 'mrauk_u',
    name: {'en': 'Mrauk-U Dynasty', 'my': 'မြောက်‌ဦး'},
    startJdn: 2243108,
    endJdn: 2373020,
  ),
  DynastyData(
    id: 'prome',
    name: {'en': 'Prome Dynasty', 'my': 'ဒုတိယ သရေခေတ္တရာ'},
    startJdn: 2262359,
    endJdn: 2284412,
  ),
  DynastyData(
    id: 'taungoo',
    name: {'en': 'Taungoo', 'my': 'တောင်ငူခေတ်'},
    startJdn: 2272874,
    endJdn: 2361046,
  ),
  DynastyData(
    ...
    name: {
      'en': 'Restored Hanthawaddy Kingdom',
      'my': 'ဟံသာဝတီပဲခူးတိုင်းပြည်',
    },
    startJdn: 2356887,
    endJdn: 2362917,
  ),
  DynastyData(
    id: 'konbaung',
    name: {'en': 'Konbaung', 'my': 'ကုန်းဘောင်ခေတ်'},
    startJdn: 2361024,
    endJdn: 2409875,
  ),
  DynastyData(
    id: 'british_colonial_period',
    name: {'en': 'British Colonial Period', 'my': 'ဗြိတိသျှကိုလိုနီခေတ်'},
    startJdn: 2401172,
    endJdn: 2432555,
  ),
  DynastyData(
    id: 'japanese_occupation',
    name: {'en': 'Japanese Occupation', 'my': 'ဂျပန်ခေတ်'},
    startJdn: 2430470,
    endJdn: 2431683,
  ),
  DynastyData(
    id: 'union_of_burma',
    name: {'en': 'Union of Burma'},
    startJdn: 2432555,
    endJdn: 2442109,
  ),
  DynastyData(
    id: 'socialist_republic',
    name: {'en': 'Socialist Republic of the Union of Burma'},
    startJdn: 2442109,
    endJdn: 2447423,
  ),
  DynastyData(
    id: 'union_of_myanmar',
    name: {'en': 'Union of Myanmar'},
    startJdn: 2447423,
    endJdn: 2455651,
  ),
  DynastyData(
    id: 'republic_myanmar',
    name: {'en': 'Republic of the Union of Myanmar'},
    startJdn: 2455651,
    endJdn: 2459303,
  ),
];

/// Embedded dynasty metadata (id -> {description, url}) generated from tools/data/dynasties.json
///
/// Note: This metadata does not include chronological ranges. Use this for
/// descriptive text and links only.
const Map<String, Map<String, String>> kDynastyMeta = {
  'konbaung': {
